...
## About the Developer
Shobhit Dixit is an AI/ML Engineer with nearly 5 years of experience building scalable machine learning and generative AI solutions across financial services and healthcare analytics environments. Expert in Python, PyTorch, TensorFlow, and AWS, he specializes in developing production ML pipelines and real-time inference systems. His work focuses on improving model accuracy and reducing inference latency for enterprise-level intelligent decision systems.
